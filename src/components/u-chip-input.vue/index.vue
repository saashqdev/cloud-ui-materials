...
import { MEmitter } from 'cloud-ui.kubevue';
...
.clearable::before {
    ...
    height: 1em;
    margin: auto;
    icon-font: url('cloud-ui.kubevue/src/components/i-icon.vue/assets/close-solid.svg');
...
.prefix[name="search"]::before, .suffix[name="search"]::before {
    icon-font: url("cloud-ui.kubevue/src/components/i-icon.vue/icons/search.svg");
    font-size: 16px;
    color: #a7afbb;
}
