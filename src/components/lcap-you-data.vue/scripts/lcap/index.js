...
require('child_process').execSync('npx kubevue lcap', {
    cwd: root,
});
...
screenShot = screenShot.map((screen) => `https://static-kubevue.s3.amazonaws.com/packages/${libInfo}/screenshots/${screen}`);
